...
public class ProductInterestAdapter extends RecyclerView.Adapter<ProductInterestAdapter.dataViewHolder> {
    Activity context;
    LayoutInflater layoutInflater;
    ArrayList<ProductInterest> categoriesModels;
    ...
    public ProductInterestAdapter(Activity context, ArrayList<ProductInterest> categoriesModels) {
    ...
    public void onBindViewHolder(@NonNull dataViewHolder holder, @SuppressLint("RecyclerView") int position) {
        try {
            ProductInterest categories = categoriesModels.get(position);
...
//                        context.startActivity(intent);
            ...
            if (userData.getId().equalsIgnoreCase(categories.vendor_id)) {
