...
public class HotelStayAdapter extends RecyclerView.Adapter<HotelStayAdapter.dataViewHolder> {
    Activity context;
    LayoutInflater layoutInflater;
    ArrayList<HotelStay> categoriesModels;
    private OnAdapterItemClickListner listner;
    public boolean isviewall = false;
    int width = 0;

    public HotelStayAdapter(Activity context, ArrayList<HotelStay> categoriesModels) {
    ...
    public dataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.adapter_hotel_layout, parent, false);
        if (isviewall)
            view = layoutInflater.inflate(R.layout.adapter_hotel_layout_viewall, parent, false);
    ...
    public void onBindViewHolder(@NonNull dataViewHolder holder, @SuppressLint("RecyclerView") int position) {
        try {
            HotelStay categories = categoriesModels.get(position);
