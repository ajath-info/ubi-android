...
public class LocationStateAdapter extends RecyclerView.Adapter<LocationStateAdapter.dataViewHolder> {
    Activity context;
    LayoutInflater layoutInflater;
    ArrayList<StatesModel> categoriesModels;
    private OnAdapterItemClickListner listner;


    public LocationStateAdapter(Activity context, ArrayList<StatesModel> categoriesModels) {
    ...
    public void onBindViewHolder(@NonNull dataViewHolder holder, @SuppressLint("RecyclerView") int position) {
        try {
            StatesModel categories = categoriesModels.get(position);
...
//            }
            ...
            holder.countrytxt.setText(categories.state_name);
