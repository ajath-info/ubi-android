...
public class DealViewAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toptitletv.setText("Deals");
        progressbar = findViewById(R.id.progressbar);
        dealAdapter = new DealAdapter(this, dealsModels);
        dealAdapter.setListner(new OnAdapterItemClickListner() {
            @Override
            public void onClick(View view, int pos) {
                Intent intent = new Intent(DealViewAllActivity.this, ProductDetailActivity.class);
                intent.putExtra("product_id", dealsModels.get(pos).getId());
                startActivity(intent);
            }
        });
        dealAdapter.isviewall = true;
    ...
    private void getHomeData(Map<String, String> params) {
        if (AppUtils.isConnectingToInternet(this)) {
            ...
            Call<DealsResponse> call = apiInterface.dealsDayAll(token, params);
                    ...
                    try {
                        ...
                        if (response.code() == 200) {
                            if (response.body().code == 1) {
                                ...
                                AppUtils.showalert(DealViewAllActivity.this, response.body().message, false);
                            }
                        } else {
                            AppUtils.showalert(DealViewAllActivity.this, response.message(), false);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
            ...
            AppUtils.Nointernetalert(DealViewAllActivity.this);
        }
    }
}